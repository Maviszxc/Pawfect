          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <Link
                  href={item.href}
                  className="relative px-1 py-2 text-gray-800 hover:text-orange-600 transition-colors duration-200 group"
                >
                  <span
        ...
        >
          <ul className="py-3 px-4">
            ...
            <li className="mt-3 pt-3 border-t border-gray-100">
              <Link
                href="/faqs"
                className=" py-2 px-3 rounded-lg text-gray-600 hover:bg-gray-50 flex items-center gap-2"
